...
-- Recreate permissions table with proper constraints
...
-- Create role_permissions table with proper foreign keys and constraints
CREATE TABLE public.role_permissions (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  role text NOT NULL CHECK (role IN ('admin', 'student', 'teacher', 'polo_manager', 'partner', 'operator')),
