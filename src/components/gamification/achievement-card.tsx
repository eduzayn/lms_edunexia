...
const AchievementCard: React.FC<AchievementCardProps> = ({
  ...
  return (
    <Card className={`
      ...
      ${achieved 
        ? 'bg-gradient-to-br from-blue-50 to-indigo-100 border-blue-200 shadow-md' 
    ...
    `}>
        ...
        <div className="flex items-start">
          <div className={`
            ...
            ${achieved 
              ...
              : 'bg-gray-200 text-gray-500 group-hover:bg-blue-50 group-hover:text-blue-500'}
          `}>
          ...
          <div>
            <h3 className={`text-lg font-semibold ${achieved ? 'text-blue-800' : 'text-gray-700'}`}>
              {achievement.name}
            </h3>
      ...
      <CardFooter className="px-4 py-3 bg-gradient-to-r from-transparent to-gray-50 border-t border-gray-100">
