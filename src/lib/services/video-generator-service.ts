...
export class VideoGeneratorService {
  ...
  async generateAudioFromScript(_script: string): Promise<{ success: boolean; audioUrl?: string; error?: string }> {
    try {
  ...
  async generateVideoWithAudio(_audioUrl: string, _title: string): Promise<{ success: boolean; videoUrl?: string; thumbnailUrl?: string; error?: string }> {
    try {
  ...
  async generateSubtitles(_audioUrl: string): Promise<{ success: boolean; subtitlesUrl?: string; error?: string }> {
    try {
